...
assert 6 'int main() { return 4+5-3; }'
...
assert 10 'int main() { return - - +10; }'
assert 80 'int main() { return 8 * - - 10; }'

#
assert 0 'int main() { return 0==1; }'
assert 1 'int main() { return 13==13; }'
assert 1 'int main() { return 0!=1; }'
assert 0 'int main() { return 14!=14; }'
...
assert 2 'int main() { return sub2(4, 2); } int sub2(int x, int y) { return x - y; }'
